...
public class BmiChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bmiData.add(new Entry(1, 24.2f));
        bmiData.add(new Entry(2, 23.9f));
        bmiData.add(new Entry(3, 23.6f));
        bmiData.add(new Entry(4, 23.4f));
        bmiData.add(new Entry(5, 23.1f));
        bmiData.add(new Entry(6, 22.9f));
        bmiData.add(new Entry(7, 22.8f));
